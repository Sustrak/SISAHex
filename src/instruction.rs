...
pub fn init_ins_dic() -> InsDic {
    ...
    let s: String = String::from(r"r(?P<rd>\d),\sr(?P<ra>\d),\sr(?P<rb>\d)");
    let mut c = Codes {
        opcode: 0,
        f: 0
    };
    ...
    ins_dic.parse_ins.insert(String::from("not"), s.clone());
    ...
    ins_dic.uses.insert(String::from("not"), vec![String::from("rd"), String::from("ra"), String::from("rb")]);
    ...
    ins_dic.parse_ins.insert(String::from("addi"), String::from(r"r(?P<rd>\d),\sr(?P<ra>\d),\s(?P<n>\d{1,})"));
    ...
    ins_dic.parse_ins.insert(String::from("ld"), String::from(r"r(?P<rd>\d),\s(?P<n>-?\d{1,})\(r(?P<ra>\d)\)"));
    ...
    ins_dic.parse_ins.insert(String::from("st"), String::from(r"(?P<n>-?\d{1,})\(r(?P<ra>\d)\),\sr(?P<rd>\d)"));
    ...
    ins_dic.parse_ins.insert(String::from("ldb"), String::from(r"r(?P<rd>\d),\s(?P<n>-?\d{1,})\(r(?P<ra>\d)\)"));
    ...
    ins_dic.parse_ins.insert(String::from("stb"), String::from(r"(?P<n>-?\d{1,})\(r(?P<ra>\d)\),\sr(?P<rd>\d)"));
    ...
    ins_dic.parse_ins.insert(String::from("movi"), String::from(r"r(?P<rd>\d),\s(?P<n>\d{1,})"));
    ins_dic.parse_ins.insert(String::from("movhi"), String::from(r"r(?P<rd>\d),\s(?P<n>\d{1,})"));
